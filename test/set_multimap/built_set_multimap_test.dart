...
void main() {
  group('BuiltSetMultimap', () {
    ...
    test('reports non-emptiness', () {
      final map = new BuiltSetMultimap<int, String>({1: ['1']});
    ...
    test('can be converted to Map<K, BuiltSet<V>>', () {
      expect(new BuiltSetMultimap<int, String>()
          .toMap() is Map<int, BuiltSet<String>>, isTrue);
      expect(new BuiltSetMultimap<int, String>()
          .toMap() is Map<int, BuiltSet<int>>, isFalse);
      expect(new BuiltSetMultimap<int, String>()
          .toMap() is Map<String, BuiltSet<String>>, isFalse);
    });

    test('can be converted to SetMultimapBuilder<K, V>', () {
      expect(new BuiltSetMultimap<int, String>()
          .toBuilder() is SetMultimapBuilder<int, String>, isTrue);
      expect(new BuiltSetMultimap<int, String>()
          .toBuilder() is SetMultimapBuilder<int, int>, isFalse);
      expect(new BuiltSetMultimap<int, String>()
          .toBuilder() is SetMultimapBuilder<String, String>, isFalse);
    });
    ...
    test(
      ...
      expect(new BuiltSetMultimap<int, String>()
          .toBuilder()
          .build() is BuiltSetMultimap<int, String>, isTrue);
      expect(new BuiltSetMultimap<int, String>()
          .toBuilder()
          .build() is BuiltSetMultimap<int, int>, isFalse);
      expect(new BuiltSetMultimap<int, String>()
          .toBuilder()
          .build() is BuiltSetMultimap<String, String>, isFalse);
    });

    test('throws on null keys', () {
      expect(() => new BuiltSetMultimap<int, String>({null: ['1']}), throws);
    });
    ...
    test('caches hash', () {
      final multimap =
          new BuiltSetMultimap<Object, Object>({1: [new _HashcodeOnlyTwice()]});
    ...
    test('compares not equal to different length BuiltSetMultimap', () {
      expect(
          new BuiltSetMultimap<int, String>({1: ['1'], 2: ['2'], 3: ['3']}) ==
              new BuiltSetMultimap<int, String>({1: ['1'], 2: ['2']}), isFalse);
    });

    test('compares not equal to different hashcode BuiltSetMultimap', () {
      expect(BuiltCollectionTestHelpers.overridenHashcodeBuiltSetMultimap(
              {1: ['1'], 2: ['2'], 3: ['3']}, 0) ==
    ...
    test('provides toString() for debugging', () {
      expect(new BuiltSetMultimap<int, String>({1: ['1'], 2: ['2'], 3: ['3']})
    ...
    test('has rebuild method', () {
      expect(new BuiltSetMultimap<int, String>({0: ['0']})
          .rebuild((b) => b.add(1, '1'))
          .toMap(), {0: ['0'], 1: ['1']});
    });
    ...
    test('has a method like SetMultimap[]', () {
      expect(
          new BuiltSetMultimap<int, String>({1: ['1'], 2: ['2'], 3: ['3']})[2],
          ['2']);
      expect(
          new BuiltSetMultimap<int, String>({1: ['1'], 2: ['2'], 3: ['3']})[4],
          []);
    });
